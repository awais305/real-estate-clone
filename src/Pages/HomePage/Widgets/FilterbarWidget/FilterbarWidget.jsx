...
const FilterbarWidget = ({ isPropertyFilter }) => {
  ...
  return (
    <div
      className={`filterbar_widget${
        isPropertyFilter ? " is_property_page" : ""
      }`}
    >
